...
class MeatLoversScreen extends StatefulWidget {
  @override
  _MeatLoversScreenState createState() => _MeatLoversScreenState();
}

class _MeatLoversScreenState extends State<MeatLoversScreen> {
  @override
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                    ...
                    image: AssetImage('assets/images/tbone_steak.png'),
                  )),
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          'Only the freshest meat used in the preparation of these juicy, premium steaks',
          style: TextStyle(
